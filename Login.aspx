...
BODY {
  ...
  <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
    ...
    <tr>
      <td width="200" rowspan="2" align="left" valign="top" bgcolor="#039384"> <uc1:UCNavigation id="UserControl1" runat="server"></uc1:UCNavigation></td>
...
<tr>
                ...
                <td width="490" height="65" align="left" valign="bottom" class="title2"><ASP:Label id="lblTitle" runat="server" ForeColor="#FF0066">Login</ASP:Label></td>
                <td width="25" height="65" align="left" valign="bottom">&nbsp;</td>
              </tr>
                <tr>
                  <td width="250" align="left" valign="top" class="auto-style5"></td>
            <td width="490" align="left" valign="top" class="auto-style5">
            <form id="Form1" runat="server">
           
           
           
                      <table border="0" cellpadding="0" cellspacing="1" style="width: 88%">
                                        
                        <tr>
                          <td width="135" align="left" valign="middle" class="auto-style4"><ASP:Label id="lblUserID" runat="server" ForeColor="Black">User ID:</ASP:Label></td>
                          <td width="4" valign="middle" class="auto-style4"></td>
                          <td width="140" align="left" valign="middle" class="auto-style4"><ASP:TextBox id="txtUserID" runat="server" maxlength="20"></ASP:TextBox></td>
                <td width="202" align="left" valign="middle" class="auto-style4">
                        ...
                        <tr>
                          <td width="135" height="20" align="left" valign="middle"><ASP:Label id="lblPassword" runat="server" ForeColor="Black">Password:</ASP:Label></td>
                ...
                <td width="202" height="20" align="left" valign="middle">
                        ...
                        <tr>
                          ...
                          <td height="20" colspan="2" align="right"  valign="middle">
                              <ASP:Button CssClass="boton_formulario" id="btnLogin" runat="server" 
                                  text="LOGIN" width="86px" onclick="btnLogin_Click" BackColor="Fuchsia" ForeColor="Black"></ASP:Button></td>
                        </tr>
                      </table>
                  ...
                  <td width="25" align="left" valign="top" class="auto-style5"></td>
              </tr>
                <tr>
