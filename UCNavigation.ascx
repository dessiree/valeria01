...
<table width="200" border="0" cellspacing="1" cellpadding="0">
    ...
    <tr id="divLogin" runat="server">
      ...
      <td height="20" bgcolor="#FE2E9A"><asp:HyperLink CssClass="izq" ID="lnkCRM" NavigateUrl="Login.aspx" runat="server">CRM Login</asp:HyperLink></td>
    ...
    <tr id="divlnkHome">
      <td height="20">&nbsp;</td>
      <td bgcolor="#d2d2c6">&nbsp;</td>
      <td height="20" bgcolor="#FE2E9A"><ASP:HyperLink CssClass="izq" id="lnkHome"
				 navigateurl="Main.aspx" runat="server" ForeColor="#0000CC">Home</ASP:HyperLink></td>
      <td height="20" class="auto-style1">&nbsp;</td>
    </tr>
    <tr id="divlblVentas" >
      <td height="20" style="HEIGHT: 21px">&nbsp;</td>
      <td width="4" bgcolor="#d2d2c" style="HEIGHT: 21px">&nbsp;</td>
      <td height="20" bgcolor="#FE2E9A" class="titleBlanco" style="HEIGHT: 21px">
        <ASP:Label id="lblVentas" runat="server" ForeColor="Black">Ventas:</ASP:Label></td>
      <td height="20" class="auto-style2">&nbsp;</td>
    </tr>
    <tr id="divlnkAddVenta" >
      <td height="20">&nbsp;</td>
      <td width="4" bgcolor="37703e">&nbsp;</td>
      <td height="20" bgcolor="#FE2E9A">&nbsp;<ASP:HyperLink id="lnkAddVenta" runat="server" cssclass="izq2" navigateurl="AddVenta.aspx" ForeColor="#0000CC">Nueva Venta</ASP:HyperLink>&nbsp;&nbsp;&nbsp;</td>
      <td height="20" class="auto-style1">&nbsp;</td>
    </tr>
    <tr id="divlnkListVentas" >
      <td height="20">&nbsp;</td>
      <td width="4" bgcolor="37703e">&nbsp;</td>
      <td height="20" bgcolor="#FE2E9A">&nbsp;<ASP:HyperLink
    ...
    <tr id="divlblProductos" >
      ...
      <td height="20" bgcolor="#FE2E9A" class="titleBlanco">
    ...
    <tr id="divlnkAddProducto" >
      <td height="20">&nbsp;</td>
      <td width="4" bgcolor="37703e">&nbsp;</td>
      <td height="20" bgcolor="#FE2E9A">&nbsp;<ASP:HyperLink id="lnkAddProducto" runat="server" cssclass="izq2" navigateurl="AddProducto.aspx">Nuevo Producto</ASP:HyperLink>&nbsp;&nbsp;&nbsp; </td>
      <td height="20" class="auto-style1">&nbsp;</td>
    </tr>
    <tr id="divlnkListProductos" >
      <td height="20">&nbsp;</td>
      <td width="4" bgcolor="37703e">&nbsp;</td>
      <td height="20" bgcolor="#FE2E9A">&nbsp;<ASP:HyperLink id="lnkListProductos" runat="server" cssclass="izq2" navigateurl="ListProducto.aspx">Listar Productos</ASP:HyperLink>&nbsp;&nbsp;&nbsp; </td>
      <td height="20" class="auto-style1">&nbsp;</td>
    </tr>
    ...
    <tr id="divlnkAddCliente" >
      <td height="20">&nbsp;</td>
      <td width="4" bgcolor="37703e">&nbsp;</td>
      <td height="20" bgcolor="#FE2E9A">&nbsp;<ASP:HyperLink id="linkAddCliente" runat="server" cssclass="izq2" navigateurl="EditCliente.aspx">Nuevo Cliente</ASP:HyperLink>&nbsp;&nbsp;&nbsp; </td>
      <td height="20" class="auto-style1">&nbsp;</td>
    </tr>
    <tr id="divlnkListClientes" >
      <td height="20">&nbsp;</td>
      <td width="4" bgcolor="37703e">&nbsp;</td>
      <td height="20" bgcolor="#FE2E9A">&nbsp;<ASP:HyperLink id="linkListCliente" runat="server" cssclass="izq2" navigateurl="ListCliente.aspx">Listar Clientes</ASP:HyperLink>&nbsp;&nbsp;&nbsp; </td>
      <td height="20" class="auto-style1">&nbsp;</td>
    </tr>
    ...
    <tr id="divlnkChangePassword" >
      <td height="20">&nbsp;</td>
      <td width="4" bgcolor="#d2d2c6">&nbsp;</td>
      <td height="20" bgcolor="#FE2E9A" classname="izq"><ASP:HyperLink id="lnkChangePassword" class="izq"
    ...
    <tr id="divlnkLogout" >
      ...
      <td height="20" bgcolor="#FE2E9A" style="HEIGHT: 20px">
        <p>
    ...
    <tr style="background:pink" runat="server" id="trTipoSitio" visible="false">
      <td width="10">&nbsp;</td>
      <td width="4">&nbsp;</td>
      <td>TESTING...</td>
