...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
    <tr>
      <td colspan="4"><img src="Images/top_fifiu.jpg" width="1000" style="height: 101px"></td>
    </tr>
    <tr>
      <td width="200" rowspan="2" align="left" valign="top" bgcolor="#FE2E9A"><uc1:UCNavigation id="UserControl2" runat="server"></uc1:UCNavigation></td>
    ...
    <tr>
      ...
      <!--Contenido aqui-->
          ...
          <asp:GridView ID="gridClientes" runat="server" CssClass="subtitulo" EmptyDataText="No existen Registros" 
              GridLines="Horizontal" AutoGenerateColumns="False" OnRowCommand="gridClientes_RowCommand" PageSize="20">
